...
#' observed. The lower censoring limits are stored in \code{lcl}. \code{season} is the month from 1 to 12 divided by 3, then added by 1.
#' @author Chao Wang (chaowang@@connect.hku.hk), 08/2015
NULL
