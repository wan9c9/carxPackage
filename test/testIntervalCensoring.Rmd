...
dat <- carxSimCenTS(nObs=nObs,lcl=-0.5,ucl=0.5,intervalCensoring=FALSE,seed=37951*iRep)
plot(dat)
#OK


dat <- carxSimCenTS(nObs=nObs,lcl=-0.5,ucl=0.5,intervalCensoring=TRUE,seed=37951*iRep)
plot(dat)
#OK

mdl <- carx(y~X1+X2,dat,p=2)
mdl
summary(mdl)
#OK
